    ...
    public function propMerging(): Response
    {
        ...
        return Inertia::render('Features/DataLoading/PropMerging', [
            ...
            'activities' => Inertia::merge([
                [
                    'id' => random_int(1000, 9999),
                    'action' => Arr::random([__('created'), __('updated'), __('deleted'), __('restored'), __('archived'), __('published')]),
                    'subject' => Arr::random([__('Contact'), __('Organization'), __('Note'), __('Invoice'), __('Report'), __('Task')]),
