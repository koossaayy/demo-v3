...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            >
                <i18n-t keypath="Per-visit event hooks passed as options to {el0}, {el1}, etc." tag="span" scope="global"><template #el0><code class="text-xs">router.visit()</code></template><template #el1><code class="text-xs">router.post()</code></template></i18n-t>
            </FeatureHeader>
