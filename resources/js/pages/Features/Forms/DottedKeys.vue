            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <FeatureCard :title="$t('Nested Form Fields')">
                    <template #description>
                        <i18n-t keypath="Dotted notation creates nested objects: {el0} becomes {el1}." tag="span" scope="global"><template #el0><code class="text-xs">user.name</code></template><template #el1><code class="text-xs">{{
                            '{ user: { name: ... } }'
                        }}</code
                        ></template></i18n-t>
                    </template>
                    ...
                    >
                        ...
                        >
                            <legend class="px-2 text-sm font-semibold">
                                <i18n-t keypath="User ({el0})" tag="span" scope="global"><template #el0><code class="text-xs">user.*</code></template></i18n-t>
                            </legend>
                            <div class="space-y-2">
                        ...
                        >
                            <legend class="px-2 text-sm font-semibold">
                                <i18n-t keypath="Address ({el0})" tag="span" scope="global"><template #el0><code class="text-xs">address.*</code></template></i18n-t>
                            </legend>
                            <div class="space-y-2">
                        ...
                        >
                            <legend class="px-2 text-sm font-semibold">
                                <i18n-t keypath="Tags ({el0})" tag="span" scope="global"><template #el0><code class="text-xs">tags[]</code></template></i18n-t>
                            </legend>
                            <div
