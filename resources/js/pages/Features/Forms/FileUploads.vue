            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <div class="space-y-6">
                    <FeatureCard info-card :title="$t('Upload State')">
                        <template #description> {{ $t('Tip: If you\'re on a fast network, throttle it in DevTools (Network → Slow 3G) to see the progress percentage in action.') }} </template>
                        <div class="space-y-3">
                    ...
                    <FeatureCard info-card :title="$t('Selected Files')">
                        ...
                        >
                            ...
                            <div v-if="form.files.length">
                                ...
                                >{{ $t('{0} selected', [form.files.length]) }}
                            </div>
                        </div>
