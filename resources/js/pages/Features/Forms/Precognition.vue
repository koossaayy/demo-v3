            ...
            >
                ...
                <div class="space-y-6">
                    ...
                    <FeatureCard
                        info-card
                        :title="$t('Actions')"
                        :description="$t('validate() only triggers a precognitive request when the field\'s value differs from its default. Unchanged fields are skipped.')"
                    >
            ...
            >
                <FeatureCard :title="$t('Create Account (Form Component)')">
                    <template #description>
                        <i18n-t keypath="The {el0} component has built-in precognition support via {el1} and slot props like {el2}, {el3}, {el4}." tag="span" scope="global"><template #el0><code class="text-xs">&lt;Form&gt;</code></template><template #el1><code class="text-xs">:validation-timeout</code></template><template #el2><code class="text-xs">validate</code></template><template #el3><code class="text-xs">valid</code></template><template #el4><code class="text-xs">invalid</code></template></i18n-t>
                    </template>
                ...
                <div class="space-y-6">
                    <FeatureCard info-card :title="$t('Form Component vs useForm')">
                        <div class="space-y-3 text-sm text-muted-foreground">
                            ...
                            />
                            <p>
                                <i18n-t keypath="Both approaches provide the same precognition features. The {el0} component uses native HTML inputs and exposes validation via slot props, while {el1} uses {el2} bindings." tag="span" scope="global"><template #el0><code
