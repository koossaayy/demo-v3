...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            > {{ $t('Template-based <Form> component with slot props. No useForm composable needed.') }} </FeatureHeader>

            <div class="grid gap-6 lg:grid-cols-2">
                <!-- Form -->
                <FeatureCard :title="$t('Demo Form')">
                    <template #description> {{ $t('Uses the <Form> component with native HTML inputs and slot props.') }} </template>
                    ...
                    >
                        <div class="space-y-4">
                            ...
                            <p class="text-sm text-muted-foreground">
                                <i18n-t keypath="These buttons call methods via {el0} from outside the <Form> slot scope." tag="span" scope="global"><template #el0><code
