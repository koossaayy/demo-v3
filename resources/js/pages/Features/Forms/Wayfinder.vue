            ...
            <div class="space-y-10">
                        ...
                        >
                            ...
                            <div class="mt-3 flex flex-wrap gap-2">
                                ...
                                >
                                    ...
                                    >
                                        {{ $t('Edit {0}', [sampleContact.first_name]) }}
                                    </Link>
                                </Button>
                            </div>
                        </FeatureCard>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-muted-foreground">
                            <i18n-t keypath="The {el0} method returns {el1} for use with {el2} on the {el3} component." tag="span" scope="global"><template #el0><code class="rounded bg-muted px-1 py-0.5 text-xs"
                                >.form()</code
                            ></template><template #el1><code
                                class="rounded bg-muted px-1 py-0.5 text-xs"
                                >{{ '{ action, method }' }}</code
                            ></template><template #el2><code class="rounded bg-muted px-1 py-0.5 text-xs"
                                >v-bind</code
                            ></template><template #el3><code class="rounded bg-muted px-1 py-0.5 text-xs"
                                >&lt;Form&gt;</code
                            ></template></i18n-t>
                        </p>
                        <CodeBlock class="mt-2">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-muted-foreground">
                            <i18n-t keypath="Real-time server-side validation. Pass the Wayfinder URL to {el0} or the {el1} component. The route must use the {el2} middleware." tag="span" scope="global"><template #el0><code class="rounded bg-muted px-1 py-0.5 text-xs"
                                >useForm</code
                    ...
                    <div class="grid gap-6 lg:grid-cols-2">
                        <FeatureCard :title="$t('useForm + Precognition')">
                            <template #description>
                                <i18n-t keypath="Chain {el0} on {el1} and pass a Wayfinder route directly." tag="span" scope="global"><template #el0><code
                                    class="rounded bg-muted px-1 py-0.5 text-xs"
                        ...
                        <FeatureCard title="<Form> + Precognition">
                            <template #description>
                                <i18n-t keypath="The {el0} component has built-in precognition support. Use {el1} or pass the action object, then add {el2} to enable it." tag="span" scope="global"><template #el0><code
                                    class="rounded bg-muted px-1 py-0.5 text-xs"
                                    >&lt;Form&gt;</code
                                ></template><template #el1><code
                                    class="rounded bg-muted px-1 py-0.5 text-xs"
