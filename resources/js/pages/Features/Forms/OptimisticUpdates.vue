...
function toggleFavoriteRouter(
    ...
    log(t('[router.optimistic] Toggling {0}...', [contact.first_name]));
...
function toggleFavoriteUseForm(
    ...
    log(t('[useForm.optimistic] Toggling {0}...', [contact.first_name]));
                ...
                <FeatureCard :title="$t('Contacts')">
                    <template #description>
                        <template v-if="activeTab === 'router'"
                            ><i18n-t keypath="{el0}. Declarative prop updates with automatic rollback." tag="span" scope="global"><template #el0><code class="text-xs">router.optimistic()</code></template></i18n-t></template
                        >
                        <template v-else-if="activeTab === 'useForm'"
                            ><i18n-t keypath="{el0}. Chained on the form helper." tag="span" scope="global"><template #el0><code class="text-xs">useForm().optimistic()</code
                            ></template></i18n-t></template
                        >
                        <template v-else
                            ><i18n-t keypath="{el0}. Optimistic updates on the Form component." tag="span" scope="global"><template #el0><code class="text-xs"
