...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            >
                <i18n-t keypath="State persistence across browser history navigation with {el0}." tag="span" scope="global"><template #el0><code class="text-xs">useRemember()</code></template></i18n-t>
            </FeatureHeader>
            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <FeatureCard info-card :title="$t('Remembered Counter')">
                    <template #description>
                        <i18n-t keypath="A separate {el0} instance with its own key." tag="span" scope="global"><template #el0><code class="text-xs">useRemember()</code></template></i18n-t>
                    </template>
                    <div class="space-y-4">
                        ...
                        >
                            ...
                            <p class="mt-1">
                                <i18n-t keypath="{el0}. Save state" tag="span" scope="global"><template #el0><code>router.remember(data, 'key')</code></template></i18n-t>
                            </p>
                            <p>
                                <i18n-t keypath="{el0}. Restore state" tag="span" scope="global"><template #el0><code>router.restore('key')</code></template></i18n-t>
                            </p>
                        </div>
                    </div>
                </FeatureCard>
