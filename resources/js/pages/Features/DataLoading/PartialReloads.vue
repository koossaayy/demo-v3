                                ...
                                <Button
                                    ...
                                    @click="
                                        router.reload({
                                            ...
                                            onSuccess: () =>
                                                log(
                                                    $t('Reloaded: timestamp + randomNumber'),
                                                ),
                                        })
                                    "
                                ...
                                <Button
                                    ...
                                    @click="
                                        router.reload({
                                            ...
                                            onSuccess: () =>
                                                log(
                                                    $t('Reloaded all except: stats + users'),
                                                ),
                                        })
                                    "
