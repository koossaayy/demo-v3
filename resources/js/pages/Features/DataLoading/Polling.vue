            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <FeatureCard :title="$t('Polling Controls')">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            <p>
                                <i18n-t keypath="{el0} With {el1} and a slow server, watch {el2} climb past 1. {el3} keeps it at 1 by aborting, {el4} keeps it at 1 by waiting the interval after each response." tag="span" scope="global"><template #el0><strong>{{ $t('Tip:') }}</strong></template><template #el1><code>overlap</code></template><template #el2><em>{{ $t('In flight') }}</em></template><template #el3><code>cancel</code></template><template #el4><code>rest</code></template></i18n-t>
                            </p>
                        </div>
                    </div>
                </FeatureCard>
