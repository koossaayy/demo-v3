        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                >
                    <div class="space-y-3">
                        <p class="text-xs text-muted-foreground">
                            <i18n-t keypath="Uses {el0} to redirect back with flash data." tag="span" scope="global"><template #el0><code>Inertia::flash('message', ...)->back()</code></template></i18n-t>
                        </p>
                        <Button
                            variant="outline"
                            size="sm"
                ...
                >
                    <div class="space-y-3">
                        <p class="text-xs text-muted-foreground">
                            <i18n-t keypath="Uses {el0} then {el1} to redirect to a named route." tag="span" scope="global"><template #el0><code>Inertia::flash(...)</code></template><template #el1><code
                ...
                >
                    <div class="space-y-3">
                        <p class="text-xs text-muted-foreground">
                            <i18n-t keypath="Triggers a full page visit to an external URL via {el0}. The browser navigates away from the SPA entirely." tag="span" scope="global"><template #el0><code>window.location</code></template></i18n-t>
                        </p>
                        <Button
                            variant="outline"
                            size="sm"
