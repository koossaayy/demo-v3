            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <FeatureCard :title="$t('With View Transitions')">
                    <template #description>
                        <i18n-t keypath="These links use {el0} for a smooth cross-fade animation." tag="span" scope="global"><template #el0><code class="rounded bg-muted px-1 py-0.5 text-xs"
                ...
                >
                    <template #description>
                        <i18n-t keypath="Use {el0} for programmatic navigation with transitions." tag="span" scope="global"><template #el0><code class="rounded bg-muted px-1 py-0.5 text-xs"
