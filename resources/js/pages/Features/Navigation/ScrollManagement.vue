    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                >
                    <div class="space-y-3">
                        <p class="text-xs text-muted-foreground"> {{ $t('Add the') }} <code>scroll-region</code> {{ $t('attribute to any scrollable container. Inertia will track and restore its scroll position during back/forward navigation.') }} </p>
                        <div
                            scroll-region
