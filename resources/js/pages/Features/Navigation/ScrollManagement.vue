                ...
                >
                    <div class="space-y-3">
                        <p class="text-xs text-muted-foreground">
                            <i18n-t keypath="Add the {el0} attribute to any scrollable container. Inertia will track and restore its scroll position during back/forward navigation." tag="span" scope="global"><template #el0><code>scroll-region</code></template></i18n-t>
                        </p>
                        <div
                            scroll-region
