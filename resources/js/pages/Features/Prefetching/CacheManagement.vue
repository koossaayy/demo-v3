            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                >
                    <div class="space-y-4">
                        ...
                        >
                            <p>
                                <i18n-t keypath="{el0} Forms can auto-invalidate cache on submission with {el1}." tag="span" scope="global"><template #el0><strong>Tip:</strong></template><template #el1><code>:invalidate-cache-tags="['tag']"</code></template></i18n-t>
                            </p>
                        </div>
                    </div>
                </FeatureCard>
