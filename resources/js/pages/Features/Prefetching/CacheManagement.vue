            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <FeatureCard :title="$t('Cache Tags')">
                    <template #description>
                        <i18n-t keypath="Tag prefetched data with {el0} for targeted invalidation." tag="span" scope="global"><template #el0><code class="text-xs">cache-tags</code></template></i18n-t>
                    </template>
                    <div class="space-y-4">
                        <div class="space-y-2">
                ...
                >
                    <div class="space-y-4">
                        ...
                        >
                            <p>
                                <i18n-t keypath="{el0} Forms can auto-invalidate cache on submission with {el1}." tag="span" scope="global"><template #el0><strong>{{ $t('Tip:') }}</strong></template><template #el1><code>:invalidate-cache-tags="['tag']"</code></template></i18n-t>
                            </p>
                        </div>
                    </div>
                </FeatureCard>
