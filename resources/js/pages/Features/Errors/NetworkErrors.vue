            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <FeatureCard :title="$t('Error Interception')">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            <p>
                                <i18n-t keypath="{el0} Open DevTools → Network → set throttling to &quot;Offline&quot;, then try navigating." tag="span" scope="global"><template #el0><strong>To test:</strong></template></i18n-t>
                            </p>
                        </div>
                    </div>
                </FeatureCard>
